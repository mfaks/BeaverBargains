            ...
            <Card className="w-full max-w-lg border-2 border-orange-400 animate-slide-in">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder="abc@example.com" {...field} className="w-full text-lg p-3" />
                                        </FormControl>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input type="password" placeholder="" {...field} className="w-full text-lg p-3" />
                                        </FormControl>
                                        <FormMessage className="text-base" />
                                    </FormItem>
                                )}
                            />
                            <Button type="submit" className="w-full bg-orange-400 text-white hover:bg-orange-500 focus:bg-orange-500 text-lg py-3">
                                Sign In
                            </Button>
                        </form>
                    </Form>
                ...
                <CardFooter className="flex flex-col space-y-4">
                    <p className="text-base text-gray-600">
                        ...
                        <Link href="/register" className="text-orange-400 underline ml-2 hover:underline">
                            Create Account
                        </Link>
                    </p>
