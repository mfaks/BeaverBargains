  ...
  useEffect(() => {
    if (lastUpdatedItem) {
      const updateItemsList = (items: Item[]) =>
        items.map((item) =>
          item.id === lastUpdatedItem.id ? lastUpdatedItem : item,
        );
            ...
            <main className="flex-1 overflow-y-auto">
              ...
              <div className="max-w-6xl mx-auto p-6">
                <Tabs defaultValue="active" className="w-full mb-6">
                  ...
                  <TabsContent
                    value="active"
                    className={`tab-content ${isTabChanging ? "loading" : ""}`}
                  >
                      ...
                      <EmptyStateCard
                        ...
                        description={
                          activeItems.length > 0
                            ...
                            : "You don't have any active listings. Start selling to see your listings here!"
                        }
                        actionText={
                          activeItems.length > 0
                            ? "Clear Filters"
                    ...
                    {loading || isTabChanging ? (
                      ...
                      <EmptyStateCard
                        ...
                        description={
                          soldItems.length > 0
                            ? "There are no items matching your current filters."
                            : "You haven't sold any items yet. Keep listing and promoting your items!"
                        }
                        actionText={
                          soldItems.length > 0
                            ? "Clear Filters"
