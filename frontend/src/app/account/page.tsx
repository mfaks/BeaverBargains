...
export default function Account() {
  ...
  const { isAuthenticated, user, loading, updateUserProfileImageUrl } =
    useAuth();
  const [isNewImageUploaded, setIsNewImageUploaded] = useState(false);
  const [showRemoveImageConfirmation, setShowRemoveImageConfirmation] =
    useState(false);
    ...
    if (
      ...
      try {
        ...
        toast({
          title: "Success",
          description:
            "Your account has been deleted successfully. Navigating back to home.",
          variant: "default",
        });
        ...
        <div className="flex flex-col min-h-screen bg-orange-50 text-orange-500">
          ...
          <div className="flex-1 overflow-hidden">
            <div className="bg-orange-100 py-3 mb-6 flex items-center justify-center">
              ...
              <h1 className="text-xl font-bold text-center text-orange-700">
                My Account
              </h1>
            ...
            <main className="container mx-auto px-4 py-6">
                        ...
                        <Avatar
                          ...
                          onDoubleClick={() =>
                            handleImageDoubleClick(
                              getFullImageUrl(userDetails?.profileImageUrl),
                            )
                          }
                        >
                          <AvatarImage
                            src={getFullImageUrl(userDetails?.profileImageUrl)}
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              ...
                              setBioChanged(
                                userDetails
                                  ? e.target.value !== userDetails.bio
                                  : false,
                              );
                            }}
                            className="border-gray-300 h-8 text-sm"
                    ...
                    <CardContent className="p-3 flex-1 space-y-2">
                      <div className="flex flex-col items-center space-y-2">
                        ...
                        <div className="flex justify-center space-x-2">
                          ...
                          !isNewImageUploaded ? (
                            <AlertDialog
                              open={showRemoveImageConfirmation}
                              onOpenChange={setShowRemoveImageConfirmation}
                            >
                              ...
                              <AlertDialogContent className="bg-white rounded-lg shadow-lg border border-orange-200 p-6 max-w-md mx-auto">
                                <AlertDialogHeader>
                                  <AlertDialogTitle className="text-xl font-semibold text-orange-700 mb-2">
              ...
              {loading ? (
                ...
                <Card className="bg-white shadow rounded-lg text-black mt-6">
                  <CardHeader>
                    <CardTitle className="text-center font-semibold text-base">
                      Quick Actions
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                      ...
                      {[
                        {
                          ...
                          description:
                            "View your messages with buyers and sellers.",
                        ...
                        },
                        {
                          ...
                          icon: FaHeart,
                          description:
                            "View items you've added to your favorites.",
                        ...
                        },
                        {
                          ...
                          icon: FaList,
                          description:
                            "Manage the items you are listing for sale.",
                          action: "View Listed Items",
                        },
                        {
                          title: "Orders",
                          icon: FaBox,
                          description: "View the status of your orders.",
