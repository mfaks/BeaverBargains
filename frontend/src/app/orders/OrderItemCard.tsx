...
const OrderItemCard: React.FC<OrderItemCardProps> = ({
  ...
  return (
    <Card className="w-full h-auto rounded-lg overflow-hidden shadow-lg cursor-pointer border-2 border-orange-300 flex flex-col">
        ...
        <div>
          ...
          <div className="text-xs text-gray-600 mb-2">
            ...
            <div className="flex items-center">
              ...
              <span>
                Listed On:{" "}
                {new Date(order.listingDate).toLocaleDateString("en-US", {
                  year: "numeric",
                  month: "long",
                  day: "numeric",
                })}
