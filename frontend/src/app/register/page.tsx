      ...
      <Card className="w-full max-w-md border-2 border-orange-400 animate-slide-in">
        ...
        <CardContent className="pt-2">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full bg-orange-400 text-white hover:bg-orange-500 focus:bg-orange-500 text-sm py-2"
              >
                Create Account
              </Button>
            </form>
        ...
        <CardFooter className="flex flex-col space-y-2">
          <p className="text-sm text-gray-600">
            ...
            <Link
              href="/login"
              className="text-orange-400 underline ml-1 hover:underline"
            >
              Sign In
            </Link>
          </p>
