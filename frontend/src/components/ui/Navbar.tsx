...
export default function NavBar({ searchQuery = "" }: NavBarProps) {
  ...
  const { unreadCount, fetchUnreadCount, clearUnreadCount } =
    useUnreadMessages();
        ...
        <div className="flex-grow mx-4">
          <form onSubmit={handleSearch} className="max-w-3xl mx-auto relative">
            <Input
              type="search"
              placeholder={
                isAuthenticated ? "Search BeaverBargains" : "Login to search"
              }
        ...
        <nav className="flex gap-4 sm:gap-6 items-center">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="p-0 h-auto hover:bg-orange-900 border-2 border-orange-500 rounded-full relative"
              >
              ...
              {isAuthenticated ? (
                <div>
                  <DropdownMenuItem className="hover:bg-orange-100 focus:bg-orange-100 relative">
                    <Link
                      href="/messages"
                      className="w-full flex items-center text-orange-700"
                    >
                  ...
                  <DropdownMenuItem
                    ...
                    className="hover:bg-orange-100 focus:bg-orange-100 text-red-600"
                  >
                    Sign Out
                  </DropdownMenuItem>
                </div>
