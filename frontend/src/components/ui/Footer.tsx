  ...
  const faqs = [
    {
      ...
      answer:
        "BeaverBargains is a platform for Oregon State University students to buy and sell textbooks, furniture, and other items within the campus community.",
    },
    {
      question: "How do I create an account?",
      answer:
        "To create an account, click on the 'Join Now' button at the top of the homepage or click on the profile icon and then click on 'Create Account' in the top right corner of the homepage. You'll need to use your OSU email address to register.",
    },
    {
      question: "Is it free to list items for sale?",
      answer:
        "Yes, listing items for sale on BeaverBargains is completely free.",
    },
    {
      question: "How do I contact a seller?",
      answer:
        "When viewing an item listing, you'll see a 'Contact' button containing the seller's name. Click this to send a message directly to the seller through our platform.",
    },
    {
      question: "Is my personal information safe?",
      answer:
        "We take data security seriously. Your personal information is encrypted and never shared with third parties. All app users have been verified as registered OSU community members with their ONID ID.",
    },
    {
      question: "What if I have a question not listed here?",
      answer:
        "Feel free to contact the development team at 'beaverbargains2024@outlook.com' if you have any further questions or concerns.",
    },
  ];
        ...
        <div className="container mx-auto px-4 flex flex-col items-center">
          <div className="flex items-center justify-between w-full">
            ...
            <nav className="flex items-center space-x-4">
              ...
              <a
                href="https://github.com/mfaks/BeaverBargains"
                target="_blank"
        ...
        <DialogContent className="max-w-md bg-orange-50">
          <DialogHeader>
            ...
            <DialogDescription className="text-orange-600">
              For any questions or concerns, please feel free to contact our
              development team at beaverbargains2024@outlook.com.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <a
